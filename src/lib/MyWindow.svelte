...
<button class="absolute border self-start cursor-default" style="left: {left}px; top: {top}px; z-index: {is_focused ? "1" : "0"};" on:focusin={() => is_focused = true} on:focusout={() => is_focused = false}>
